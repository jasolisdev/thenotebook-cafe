...
export const MENU_ITEMS: MenuItem[] = [
  ...
  // Meals
  { id: "28", name: "Breakfast Sandwich", description: "Egg, cheddar, and bacon on a toasted English muffin. Add avocado +$2.", price: "$8.50", section: "meals" },
  { id: "29", name: "Avocado Toast", description: "Smashed avocado on sourdough with cherry tomatoes, feta, and chili flakes.", price: "$9.00", section: "meals", tag: "popular" },
  { id: "30", name: "Turkey & Swiss Panini", description: "Sliced turkey, Swiss cheese, spinach, and honey mustard on pressed ciabatta.", price: "$10.50", section: "meals" },
  { id: "31", name: "Grilled Cheese & Tomato Soup", description: "Classic grilled cheese on sourdough with creamy tomato basil soup.", price: "$9.50", section: "meals" },
  { id: "32", name: "Caesar Salad", description: "Crisp romaine, parmesan, croutons, and house Caesar dressing. Add chicken +$3.", price: "$9.00", section: "meals" },
  { id: "33", name: "Yogurt Parfait", description: "Greek yogurt layered with granola, fresh berries, and a drizzle of honey.", price: "$7.00", section: "meals" },
  { id: "38", name: "Classic Acai Bowl", description: "Organic acai blend topped with gluten-free granola, banana, strawberries, and local honey.", price: "$12.50", section: "meals", subcategory: "Bowls", tag: "new" },

  // Desserts
  { id: "34", name: "New York Cheesecake", description: "Classic creamy cheesecake on a graham cracker crust. Topped with berry compote.", price: "$6.00", section: "desserts" },
  { id: "35", name: "Chocolate Brownie", description: "Rich, fudgy brownie with walnuts. Served warm with vanilla ice cream.", price: "$5.00", section: "desserts", tag: "popular" },
  { id: "36", name: "Chocolate Chip Cookie", description: "Freshly baked, gooey center with semi-sweet chocolate chips. A classic favorite.", price: "$3.50", section: "desserts" },
  { id: "37", name: "Cinnamon Roll", description: "House-made cinnamon roll with cream cheese frosting. Warm and indulgent.", price: "$5.50", section: "desserts" }
];
...
const BOWL_BASE: ModifierGroup = {
  ...
  options: [
    ...
    { label: "Pitaya Base", priceDelta: 0 },
  ]
};
...
const BOWL_FRUIT: ModifierGroup = {
  ...
  type: "checkbox",
  required: true,
  description: "Select up to 3 included",
  maxSelections: 3,
  options: [
    { label: "Banana", priceDelta: 0 },
    { label: "Strawberry", priceDelta: 0 },
    { label: "Blueberry", priceDelta: 0 },
    { label: "Mango", priceDelta: 0.50 },
  ]
};

const BOWL_CRUNCH: ModifierGroup = {
  id: "crunch",
  name: "Crunch",
  type: "checkbox",
  required: false,
  options: [
    { label: "Gluten-Free Granola", priceDelta: 0 },
    { label: "Coconut Flakes", priceDelta: 0 },
    { label: "Cacao Nibs", priceDelta: 0.50 },
    { label: "Sliced Almonds", priceDelta: 0.50 },
  ]
};
...
const BOWL_DRIZZLE: ModifierGroup = {
  ...
  options: [
    ...
    { label: "Agave", priceDelta: 0 },
    { label: "Peanut Butter", priceDelta: 0.75 },
    { label: "Nutella", priceDelta: 0.75 },
    { label: "Almond Butter", priceDelta: 1.00 },
  ]
};
  ...
  food: [
    {
      ...
      required: true,
      options: [
        { label: "Include Utensils", priceDelta: 0 },
        { label: "No Utensils", priceDelta: 0 }
      ]
    }
  ]
};
