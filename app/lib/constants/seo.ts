...
export const SEO = {
  ...
  defaultDescription: 'Specialty coffee and community vibes in Riverside, CA. Visit The Notebook Café for espresso, matcha, cold brew, and signature pours. House music and creative energy await.', // 172 chars
  ...
  pages: {
    home: {
      ...
      description: 'Specialty coffee and community vibes in Riverside, CA. Visit The Notebook Café for espresso, matcha, cold brew, and signature pours. House music and creative energy await.', // 172 chars
      ogImage: '/og.png',
    },
    menu: {
      title: 'Menu | The Notebook Café, Riverside CA',
      description: 'Explore The Notebook Café menu in Riverside, CA. Espresso, cold brew, matcha, and seasonal favorites crafted daily. Discover our signature pours and house-made syrups.', // 169 chars
      ogImage: '/og-menu.png',
    },
    story: {
      title: 'Our Story | The Notebook Café, Riverside CA',
      description: 'Learn how The Notebook Café became Riverside\'s community hub for specialty coffee, creativity, and curated sound. Our journey from idea to your favorite local café.', // 166 chars
