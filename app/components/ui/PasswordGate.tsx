    ...
    <main className="min-h-screen flex items-center justify-center bg-cafe-mist px-6 py-20">
      <div className="max-w-[500px] w-full mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-cafe-black mb-3">
            THE NOTEBOOK CAFÉ
          </h1>
          <p className="text-base text-cafe-brown mb-2">
            We&apos;re currently under development
          </p>
          <p className="text-sm text-cafe-brown/80">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <div className="text-center text-sm text-red-600 bg-red-50 border border-red-200 py-2.5 px-4">
              {error}
            </div>
          )}
          ...
          <button
            ...
            className="w-full px-8 py-4 bg-cafe-black text-cafe-white text-sm font-bold uppercase tracking-widest transition-all hover:bg-cafe-black/90 disabled:opacity-50 disabled:cursor-not-allowed hover:transform hover:translate-y-[-2px] hover:shadow-lg"
          >
