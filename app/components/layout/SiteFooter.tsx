      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed opacity-80" style={{ color: "var(--coffee-100)" }}>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm" style={{ color: "var(--coffee-100)" }}>
              ...
              <li><Link href="/story" className="opacity-80 hover:opacity-100 transition-opacity">Our Story</Link></li>
              <li><Link href="/contact" className="opacity-80 hover:opacity-100 transition-opacity">Contact</Link></li>
              <li><Link href="/careers" className="opacity-80 hover:opacity-100 transition-opacity">Careers</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm opacity-80" style={{ color: "var(--coffee-100)" }}>
              <li>3512 9th St</li>
              <li>Riverside, CA 92501</li>
              <li className="pt-2">Mon-Sat: 7am - 6pm</li>
              <li>Sun: <span className="italic">Closed</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-xs mb-4 opacity-80" style={{ color: "var(--coffee-100)" }}>Join our newsletter for brewing tips and events.</p>
        ...
        <div
          className="pt-8 flex flex-col md:flex-row justify-between items-center text-xs gap-3 md:gap-6"
          style={{ borderTop: "1px solid rgba(var(--coffee-100-rgb), 0.1)", color: "var(--coffee-100)" }}
        >
          ...
          <div className="flex flex-wrap items-center gap-4 md:gap-6">
            ...
            <Link href="/terms" className="opacity-80 hover:opacity-100 transition-opacity">Terms</Link>
            <Link href="/privacy" className="opacity-80 hover:opacity-100 transition-opacity">Privacy</Link>
            <Link href="/refunds" className="opacity-80 hover:opacity-100 transition-opacity">Refunds</Link>
          </div>
        </div>
      </div>
    </footer>
