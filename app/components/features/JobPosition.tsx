  ...
  return (
    ...
    >
      ...
      <div className="mb-5 sm:mb-6">
        <h4 className="font-serif text-2xl sm:text-3xl md:text-4xl leading-tight mb-3 sm:mb-4" style={{ color: 'var(--color-cafe-black)' }}>
          {title}
        </h4>
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          <span
            className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-[0.65rem] sm:text-xs tracking-[0.15em] sm:tracking-[0.18em] uppercase font-semibold whitespace-nowrap"
            style={{
